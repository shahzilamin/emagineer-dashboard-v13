    ...
    <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 gap-6 mt-6">
          <div>
            ...
            <div className="flex items-center gap-1 mt-1 text-sm">
              ...
              <span className="text-emerald-200">vs yesterday</span>
            </div>
          </div>
          <div>
            <p className="text-emerald-200 text-sm">MTD Progress</p>
            <p className="text-3xl font-bold mt-1">{formatCurrency(metrics.revenue.mtd.current, true)}</p>
            <div className="mt-2">
              <div className="w-full h-2 bg-emerald-400/30 rounded-full overflow-hidden">
                <div
          ...
          <div>
            <p className="text-emerald-200 text-sm">Orders Today</p>
            <p className="text-3xl font-bold mt-1">{formatNumber(metrics.operations.ordersToday.current)}</p>
            <p className="text-sm text-emerald-300 mt-1">
              {formatPercentPlain(metrics.operations.onTimeRate.current)} on-time
            </p>
          </div>
          <div>
            <p className="text-emerald-200 text-sm">Gross Margin</p>
            ...
            <div className="flex items-center gap-1 mt-1 text-sm">
              ...
              <span className="text-emerald-200">from last month</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          {/* Revenue Breakdown */}
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Revenue by Stream</h3>
            <DonutChart
          ...
          {/* Top Clients */}
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Top Clients by Revenue</h3>
            <div className="space-y-3">
              {topClients.map((client, i) => (
                <div key={client.id} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="w-6 h-6 rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-xs font-medium text-slate-600 dark:text-slate-400">
                      {i + 1}
                    </span>
                    <div>
